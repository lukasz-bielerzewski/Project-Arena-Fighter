    ...
    : font(font), showList(false), keytimeMax(1.f), keytime(0.f)
{
    this->activeElement = new gui::Button(
                ...
                sf::Color(240, 240, 240, 255), sf::Color(255, 255, 255, 255), sf::Color(20, 20, 20, 100),
                sf::Color(70, 70, 70, 200), sf::Color(150, 150, 250, 200), sf::Color(20, 20, 20, 200),
